    ...
    return (
        <div >
            ...
            <div className=' max-w-xl mx-auto '>
                ...
                <form onSubmit={handleUpdateProduct} className='space-y-3' action="">
                    ...
                    <div className=''>
                        ...
                        <div className='flex gap-3'>
                            {screenshots.map(screenshot=> <div className='flex flex-row'> <img className='w-40 h-30 object-cover' src={screenshot}></img> </div> )}
                        </div>
                    </div>
